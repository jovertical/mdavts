...
@section('content')
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('root.auth.verify.request') }}" class="form-horizontal form-material" id="loginform">
                    @csrf
                        ...
                        <div class="d-flex no-block align-items-center">
                            <div class="ml-auto">
                                <a href="{{ route('root.auth.signin') }}" class="text-muted">
                                    <i class="fa fa-lock m-r-5"></i> Sign in using your account.
                                </a>
                            </div>
                        </div>
                    </div>
